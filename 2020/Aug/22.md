...
I'm trying to contribute to the Orb. For which I want to use the Orb first and
see how it works, for which I'm creating my demo buildpack and pushing it to
docker hub

And I'm also seeing how to check environment variables being set
...
https://stackoverflow.com/a/13864829/4772008

```bash
$ SECRET=""; echo ${SECRETBLAH+x}

$ SECRET=""; echo ${SECRET+x}
x
```

So, that's cool! :D

I created a repo and added circleci config to it based on the orb and it didn't
work out. Some security issue and the build failed. I had to opt in to third
party orb first

Now I try to retrigger, it doesn't help. Hmm.

https://github.com/karuppiah7890/ruby-sample-app-for-buildpack

https://app.circleci.com/pipelines/github/karuppiah7890/ruby-sample-app-for-buildpack

Now I'm getting a circleci CLI to see if it can help at all
https://circleci.com/docs/2.0/local-cli-getting-started/#section=getting-started
https://circleci.com/docs/2.0/local-cli-getting-started/#download-and-setup-the-circleci-cli

```bash
$ curl -fLSs https://circle.ci/cli | bash
Starting installation.
Installing CircleCI CLI v0.1.9321
...
Setup complete.
Your configuration has been saved to /Users/karuppiahn/.circleci/cli.yml.

Trying an introspection query on API to verify your setup... Ok.
Trying to query our API for your profile name... Hello, Karuppiah Natarajan.
```

https://circleci.com/docs/2.0/local-cli-getting-started/#setup-and-validate-our-first-config

```bash
$ pwd
/Users/karuppiahn/oss/github.com/karuppiah7890/ruby-sample-app-for-buildpack
$ circleci config validate
Config file at .circleci/config.yml is valid.
```

https://circleci.com/docs/2.0/local-cli-getting-started/#testing-a-job-before-pushing-to-a-vcs

```bash
$ circleci local execute
Downloading latest CircleCI build agent...
Docker image digest: sha256:6bf4a164f93047313eafb6424ed38b1123e0e24388ef00567a342a1bd9451ce5
====>> Spin up environment
Build-agent version  ()
Error:
...
No idea why the local execution didn't run. Anyways. I had to amend my commit
and force push to trigger a build in circleci

Apparently there are ways to test orbs

https://circleci.com/docs/2.0/testing-orbs/#runtime-testing

I'm just going to go with manual running and testing 🙈 However the local
execution didn't work. Gotta dig into that later I guess

I'm going to fork and create an orb

https://circleci.com/docs/2.0/creating-orbs/

```bash
$ circleci namespace create karuppiah7890 github karuppiah7890
You are creating a namespace called "karuppiah7890".

This is the only namespace permitted for your github organization, karuppiah7890.

To change the namespace, you will have to contact CircleCI customer support.

✔ Are you sure you wish to create the namespace: `karuppiah7890`: y
Namespace `karuppiah7890` created.
Please note that any orbs you publish in this namespace are open orbs and are world-readable.
```

```bash
$ circleci orb create karuppiah7890/pack
You are creating an orb called "karuppiah7890/pack".
...
✔ Are you sure you wish to create the orb: `karuppiah7890/pack`: y
Orb `karuppiah7890/pack` created.
Please note that any versions you publish of this orb are world-readable.
You can now register versions of `karuppiah7890/pack` using `circleci orb publish`.
```
...
But the environment variable name is more specific and in our case, we want
the user to be able to give ANY environment variable. More like a list of
values. Doesn't seem like it's possible here, hmm

Environment variables in Circle CI
https://circleci.com/docs/2.0/env-vars

I have asked the maintainers on what they meant with regards to the issue
and what's their design for the solution as there's no list type for
parameters

https://github.com/buildpacks/pack-orb/issues/6

I also found another issue in their orb config. An undefined parameter name
was used by mistake. I have fixed it and raised a PR for it

https://github.com/buildpacks/pack-orb/issues/10
https://github.com/buildpacks/pack-orb/pull/11

---

https://circleci.com/docs/2.0/creating-orbs/#using-the-cli-to-publish-orbs
